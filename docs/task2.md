...
![Successive Rotations around Fixed Axes to 45 degrees](../docs/recursos/imgs/01.jpeg)
...
![Successive Rotations around Fixed Axes to 45 degrees](../docs/recursos/imgs/02.jpeg)
...
![Successive Rotations around Fixed Axes to 45 degrees](../docs/recursos/imgs/03.jpeg)
...
![Successive Rotations around Fixed Axes to 45 degrees](../docs/recursos/imgs/04.jpeg)

### Exercise 5
- **Descripción:** This exercise is the same to the last one, we have to rewrite the robot for do more easy the analysis.
 
 ![Successive Rotations around Fixed Axes to 45 degrees](../docs/recursos/imgs/05.jpeg)
